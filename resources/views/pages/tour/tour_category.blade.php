                        ...
                        <div class="w100 fl bx-wap-pr-item">
                            ...
                            <div class="group-calendar w100 fl">
                                <div class="col-md-6 col-xs-7 date-start">
                                    ...
                                    <td> {{ \Carbon\Carbon::parse($tour->departureDates->first()->departure_date)->format('d/m/Y') }}</td>
                                    @else
                                        Không có ngày khởi hành
                                    @endif
                                </div>
                                <div class="col-md-6 col-xs-5 date-range">
                                    <span class="lst-icon1"><i class="fa fa-clock-o"></i></span><span>{{ $tour->tour_time }} </span>
                                </div>
                            </div>
                            <div class="group-location w100 fl">
                                ...
                                <div class="col-md-6 col-xs-5 number-seat">
                                    <span class="lst-icon1"><i class="fa fa-users"></i></span><span> Số chỗ: {{ $tour->departureDates->first()->available_seats ?? 0 }}</span>
                                </div>
                            </div>
