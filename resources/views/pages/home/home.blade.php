               ...
               <div class="col-md-4 col-xs-12 lst-tour-item">
                     <div class="w100 fl bx-wap-pr-item">
                        <div class="clearfix box-wap-imgpr">
                           <a href="{{route('detail-tour',['du-lich-phu-yen-5667.html'])}}">
                        ...
                        <div class="clear"></div>
                        <h4><a href="{{route('detail-tour',['du-lich-phu-yen-5667.html'])}}">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></h4>
                        <div class="clear"></div>
